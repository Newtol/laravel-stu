...
<link href="{{ URL::asset('assets/css/form.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <form action="edit_Role" method="post">
        {!!csrf_field()!!}
        <input placeholder="输入需要增加的角色名" NAME="role_Name" TYPE="text"onmouseover="this.style.borderColor='black';this.style.backgroundColor='plum'" style="width: 106; height:50" onmouseout="this.style.borderColor='black';this.style.backgroundColor='#ffffff'" style="border-width:1px;border-color=black" CLASS="text">
